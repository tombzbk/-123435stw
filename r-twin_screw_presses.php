...
<html class="no-js">
    <head>
        <title>Twin Screw Presses for Rendering production ASTW Rendering Plants A & S Thai Works Co.,Ltd www.asthaiworks.com</title>
        ...
        <div id="wrap">
            ...
            <section id="content" class="container clearfix">
                ...
                <div class="three-fourths column-last">
                    <?php
                    $sql = " SELECT * FROM `t_content` WHERE  `content_page` =  'r-twin' ";
