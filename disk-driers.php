                ...
                <div class="one-fourth bg-left">
                    <div class="entry-image" style="position:relative" id="pic-left">
                        <a href="renderingplants.php">
                            ...
                            <span style="position:absolute;top: 5px;left: 13px;color:#FFFFFF;font-size:15px;">Rendering Plants</span>
                        </a>
                ...
                <div class="three-fourths column-last">
                    ...
                    <section>
                        <div id="cal_left">
                            ...
                            $sql = "SELECT * FROM t_content WHERE content_page='f-Disk'";
