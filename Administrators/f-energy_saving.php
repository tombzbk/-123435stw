...
<html>
    ...
    <body class="skin-blue fixed">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box-body">
                                                <div class="col-md-8">
                                                    ...
                                                    if ($_REQUEST['tab_status'] == "tb-energy") {
                                                        echo "disabled";
                                                    }
                                                    ?>">
                                                        Energy Saving
        ...
        <script src="script/f-energysaving.js" type="text/javascript" id="eng" data-tab="<?php echo $_REQUEST['tab_status'] ?>"></script>
    </body>
</html>
