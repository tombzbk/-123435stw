        ...
        (function() {
            ...
            a = function(a) {
                ...
                b.prototype.init = function() {
                    ...
                    this.clickableElements.length && (d = function() {
                ...
                b.prototype.updateTotalUploadProgress = function() {
                    ...
                    if (d = 0,
                    c = 0,
                    a = this.getAcceptedFiles(),
                    a.length) {
                        for (h = this.getAcceptedFiles(),
                        f = 0,
                        g = h.length; g > f; f++)
                            b = h[f],
                ...
                b.prototype.getFallbackForm = function() {
                    ...
                    d += '<input type="file" name="' + this.options.paramName + (this.options.uploadMultiple ? "[]" : "") + '" ' + (this.options.uploadMultiple ? 'multiple="multiple"' : void 0) + ' /><input type="submit" value="Upload!"></div>',
                    c = b.createElement(d),
                    ...
                    d = function(a) {
                        ...
                        f = a.length; f > d; d++)
                            ...
                            c.isFile ? c.file(function(a) {
                                return e.options.ignoreHiddenFiles && "." === a.name.substring(0, 1) ? void 0 : (a.fullPath = "" + b + "/" + a.name,
                                e.addFile(a))
                ...
                b.prototype.addFile = function(a) {
                    ...
                    this.accept(a, function(b) {
                        ...
                        c._errorProcessing([a], b)) : c.enqueueFile(a),
                ...
                b.prototype.uploadFiles = function(a) {
                    ...
                    s.onload = function(c) {
                        ...
                        if (a[0].status !== b.CANCELED && 4 === s.readyState) {
                            if (p = s.responseText,
                            s.getResponseHeader("content-type") && ~s.getResponseHeader("content-type").indexOf("application/json"))
                                try {
                                    p = JSON.parse(p)
                                } catch (e) {
                                    c = e,
                    ...
                    if (this.options.uploadMultiple && this.emit("sendingmultiple", a, s, e),
                    "FORM" === this.element.tagName)
                        ...
                        z = F.length; z > v; v++)
                            ...
                            "SELECT" === j.tagName && j.hasAttribute("multiple"))
                                for (G = j.options,
                                w = 0,
                                A = G.length; A > w; w++)
                                    n = G[w],
