...
<html>
    ...
    <body class="skin-blue fixed">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <small> How to choose a Fishmeal Plants</small>
                    </h1>
                </section>
                <!-- Main content -->
                            ...
                            <div class="col-md-6" style="min-width: 1024px">
                                <div class="box  box-form">
                                    <div class="box-header ui-sortable-handle" style="cursor: move;">
                                        <h3 class="box-title">Fish Cooker</h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php }
                                        ?>
                                        <textarea class="summernote" data-role="<?php echo $content_ID ?>" data-current="<?php echo $current_page; ?>">
                                            <?php echo $dataTotextarea; ?>
                                        </textarea>
                                    </div>
                                    <!-- /.box-body -->
        ...
        <script src="editors/dist/summernote.min.js" type="text/javascript"></script>
        ...
        <script src="script/f-fishcooker.js" type="text/javascript"></script>
    </body>
