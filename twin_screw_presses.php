...
<html class="no-js">
    <head>
        <title>Twin Screw Presses for fish meal production ASTW Fishmeal Plants A & S Thai Works Co.,Ltd www.asthaiworks.com</title>
        <?php include ("base.php"); ?>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
        <meta http-equiv='content-type' content='text/html;charset=UTF-8' />
        <meta name="description" content="Twin Screw Presses for fish meal production ASTW,Fishmeal Plants,Rendering Plants,A & S Thai Works Co.,Ltd,Disc Driers,Contact,How to chose a Fishmeal Plant,A&S Thai Works,asthaiworks.com,Deodorizer Smell Removal,Energy Saving,Accessories,Equipment,Twin Screw Presses,A & S Thai Works Co.,Ltd (ASTW) ASTW DIRECT CONDENSATE RETURN SYSTEM (SAVE TANK) Direct Condensate Return System Save up to 12% of your boiler fuel oil consumption and save,Twin Screw Presses for fish meal production">
        <meta name="keywords" content="Twin Screw Presses for fish meal production ASTW,home astw,Fishmeal Plants,Rendering Plants,A & S Thai Works Co.,Ltd,Disc Driers,Contact,How to chose a Fishmeal Plant,A&S Thai Works,asthaiworks.com,Deodorizer Smell Removal,Energy Saving,Accessories,Equipment,Twin Screw Presses,Twin Screw Presses for fish meal production">
        ...
        <div id="wrap">
            ...
            <section id="content" class="container clearfix">
                ...
                <div class="three-fourths column-last">
                    <?php
                    $sql = " SELECT * FROM `t_content` WHERE  `content_page` =  'f-twin' ";
