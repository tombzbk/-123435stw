...
<html class="no-js">
    <head>
        <title>Fish Coockers ASTW Fishmeal Plants how to choose A & S Thai Works Co.,Ltd www.asthaiworks.com</title>
        <?php include ("base.php"); ?>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
        <meta http-equiv='content-type' content='text/html;charset=UTF-8' />
        <meta name="description" content="Fish Coockers ASTW Rendering Plants and Machinery,A & S Thai Works Co., Ltd (ASTW) is the largest manufacturer of high quality Fishmeal and Rendering plants in Asia. Based in Bangkok, Thailand, the Company operates a sophisticated production facility producing complete processing plants.,A & S THAI WORKS CO., LTD.(ASTW) 99/199 moo 1 Theparak Rd., (Km.22), Bangsaothong,Samutprakarn 10540 Thailand.">
        <meta name="keywords" content="Fish Coockers ASTW Rendering Plants and Machinery,Rendering Plants,Disc Drier, Cookers,Blood Drying,Accessories & Equipment,Energy Saving,Deodorizer Smell Removal,Photo of Plants,">
            ...
            <section id="content" class="container clearfix">
                ...
                <div id="content-detail">
                    ...
                    <div class="three-fourths column-last">
                        <?php
                        $sql = " SELECT * FROM `t_content` WHERE  `content_page` =  'r-fishcook' ";
