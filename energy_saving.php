...
<!--[if (gte IE 9)|!(IE)]><!--> <html class="no-js">
    <head>
        <!-- end JS -->
        <title>Energy Saving ASTW Fishmeal Plants A & S Thai Works Co.,Ltd www.asthaiworks.com</title>
        <?php include './base.php'; ?>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
        <meta http-equiv='content-type' content='text/html;charset=UTF-8' />
        <meta name="description" content="Energy Saving ASTW,Fishmeal Plants,Rendering Plants,A & S Thai Works Co.,Ltd,Disc Driers,Contact,How to chose a Fishmeal Plant,A&S Thai Works,asthaiworks.com,Deodorizer Smell Removal,Energy Saving,Accessories,Equipment,Twin Screw Presses,A & S Thai Works Co.,Ltd (ASTW) ASTW DIRECT CONDENSATE RETURN SYSTEM (SAVE TANK) Direct Condensate Return System Save up to 12% of your boiler fuel oil consumption and save">
        <meta name="keywords" content="Energy Saving ASTW,Fishmeal Plants,Rendering Plants,A & S Thai Works Co.,Ltd,Disc Driers,Contact,How to chose a Fishmeal Plant,A&S Thai Works,asthaiworks.com,Deodorizer Smell Removal,Energy Saving,Accessories,Equipment,Twin Screw Presses,">
                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content" id="energy-page">
                            <div id="tab1" class="tab active">
                                ...
                                <section>
                                    <div id="cal_left">
                                        ...
                                        $sql = " SELECT * FROM `t_content_tab` WHERE content_page='f-energy' AND `content_tab` =  'tb-energy' ";
                            ...
                            <div id="tab2"  class="tab">
                                <?php
                                $sql = " SELECT * FROM `t_content_tab` WHERE content_page='f-energy' AND `content_tab` =  'tb-Whe' ";
                                $res = $mysqli->query($sql);
                                $row = $res->fetch_assoc();
                                if ($row['content_detail_' . $lang] == "") {
                                      echo decodeToHtml($row['content_detail_EN']);
